...
<?php
$breadcrumb = [['url' => URL('/admin/home'), 'name' => 'Home', 'active' => ''], ['url' => '#', 'name' => 'Add Exams', 'active' => 'active']];
?>
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 style="font-size:20px;" class="card-title">Add Exam
                        </h4>
                            ...
                            <div style="width: 100%; overflow-x: scroll; padding-left: -10px;">
                                <div class="table-responsicve">
                                    ...
                                    <div class="form-group form-float float-left col-md-3">
                                        ...
                                        <div class="form-line">
                                            <input autocomplete="off" class="date_range_filter date form-control exam_startdate" name="exam_startdate" type="date" id="start_date"  required/> 
                                        </div>
                                    </div>
                                    <div class="form-group form-float float-left col-md-3">
                                        <label class="form-label">End Date</label>
                                        <div class="form-line">
                                            <input autocomplete="off" class="date_range_filter date exam_enddate form-control" name="exam_enddate" type="date" id="end_date"  required/> 
                                        </div>
                                    </div> 
                                    {{-- <div class="form-group form-float float-left col-md-3">
                                    ...
                                    <br>
                                    <div class="col-md-12" id="timetableentries" style="margin-top: 15%;">
    ...
    <script>
        ...
        function loadexamtable() {
            ...
            var request = $.ajax({
                ...
                data: {
                    start_date: start_date, end_date:end_date,monthyear : monthyear,exam_name : exam_name
                },
                dataType: 'json',
                encode: true
            });
