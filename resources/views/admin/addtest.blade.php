...
<?php  
$breadcrumb = [['url'=>URL('/admin/home'), 'name'=>'Home', 'active'=>''], ['url'=>URL('/admin/testlist'), 'name'=>'Tests', 'active'=>''], ['url'=>'#', 'name'=>'Add Test', 'active'=>'active'] ];
?>
@section('content')
                        ...
                        <div class="card"> 
                            <div class="card-body">
                                ...
                                <div class="row"><div class="col-md-12">
                                    <form name="frm_questionbank" id="frm_questionbank" method="post" action="{{url('/admin/view/qbfrtest')}}"> 
                                    {{csrf_field()}}
                                    <div class="row">
