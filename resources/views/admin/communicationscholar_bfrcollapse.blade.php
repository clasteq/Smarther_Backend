                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="category" name="category" required onchange="loadbgtheme();">
                                            <option value="" disabled selected>Select a category</option>
                                            @foreach ($get_category as $category)
                                                <option value="{{ $category->id }}" data-bgtheme_id="{{ $category->background_theme_id }}">{{ $category->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
