        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="style-form" enctype="multipart/form-data"
                                  action="{{url('/admin/save/districts')}}"
                                  method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group form-float float-left col-md-6">
                                <label class="form-label">District Name</label>
                                <div class="form-line">
                                    <input type="text" class="form-control" name="district_name" id="edit_district_name" required>
                                </div>
                            </div>
                            <div class="form-group form-float float-left col-md-6">
                                <label class="form-label">Status</label>
    ...
    <script>
        ...
        $(function() {
            var table = $('.tblcountries').DataTable({
                ...
                responsive: false,
                "ajax": {
                    "url":"{{URL('/')}}/admin/districts/datatables/",
                    data: function ( d ) {
                ...
                columns: [
                    ...
                    { data: 'status', name:'districts.status'},
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var tid = data.id;
                            return '<a href="#" onclick="loadDistrict('+tid+')" title="Edit District"><i class="fas fa-edit"></i></a>';
        ...
        function loadDistrict(id){
            ...
            var request = $.ajax({
                type: 'post',
                url: " {{URL::to('admin/edit/districts')}}",
                headers: {
