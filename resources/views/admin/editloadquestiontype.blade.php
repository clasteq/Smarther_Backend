@if(isset($qtype['questiontype_settings']['question_type_id']))
	...
	<input type="hidden" name="qb_item_id[]" id="qb_item_id_{{$i}}" value="0" >
	...
	<div class="form-group form-float float-left col-md-6"> 
		<div class="form-line">
		    ...
		    <input type="file" class="form-control" name="choose_question[{{$qtype['id']}}][{{$i-1}}]" id="choose_question_{{$qtype['id']}}_{{$i}}" placeholder="Question">
	...
	<div class="form-group form-float float-left col-md-6"> 
		<div class="form-line">
		    ...
		    <input type="file" class="form-control" name="choose_1[{{$qtype['id']}}][{{$i-1}}]" id="choose_1_{{$qtype['id']}}_{{$i}}" placeholder="Option 1">
		</div> 
	</div>
	@endif  
	...
	<div class="form-group form-float float-left col-md-6"> 
		<div class="form-line">
		    ...
		    <input type="file" class="form-control" name="choose_2[{{$qtype['id']}}][{{$i-1}}]" id="choose_2_{{$qtype['id']}}_{{$i}}" placeholder="Option 2">
		</div> 
	</div>
	@endif  
	...
	<div class="form-group form-float float-left col-md-6"> 
		<div class="form-line">
		    ...
		    <input type="file" class="form-control" name="choose_3[{{$qtype['id']}}][{{$i-1}}]" id="choose_3_{{$qtype['id']}}_{{$i}}" placeholder="Option 3">
		</div> 
	</div>
	@endif  
	...
	<div class="form-group form-float float-left col-md-6"> 
		<div class="form-line">
		    ...
		    <input type="file" class="form-control" name="choose_4[{{$qtype['id']}}][{{$i-1}}]" id="choose_4_{{$qtype['id']}}_{{$i}}" placeholder="Option 4">
		</div> 
	</div>
	@endif  
	...
	<div class="form-group form-float float-left col-md-8"> 
		<div class="form-line">
		    Hint File : <input type="file" class="form-control" name="hint_file[{{$qtype['id']}}][]" id="hint_file_{{$qtype['id']}}_{{$i}}" placeholder="Hint File">
		</div> 
	</div>
	@endif  
