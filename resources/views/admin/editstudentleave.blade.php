...
<?php
$breadcrumb = [['url'=>URL('/admin/home'), 'name'=>'Home', 'active'=>''], ['url'=>URL('/admin/studentsleavelist'), 'name'=>'Leaves', 'active'=>''], ['url'=>'#', 'name'=>'Update Students Leave', 'active'=>'active'] ];
?>
@section('content')
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row"><div class="col-md-12">
                                    <div class="row">
                                        <form name="students_mark" id="students_mark" method="post" action="{{URL('/')}}/admin/edit/studentleave">
                                            {{csrf_field()}}
                                        ...
                                        {{-- <div style="visibility: hidden" class="form-group form-float float-left col-md-6">
                                            <label class="form-label">Leave Attahment</label>
                                             <div class="form-line">
                                                <select class="form-control col-sm-6" name="new_status" id="new_status" > --}}
                                                     {{-- <option value="">All</option> --}}
                                                    {{-- <option <?php  if($qb['status'] == "PENDING"){
                                                       echo  "selected";
                                                      } ?> value="PENDING">PENDING</option>
                                      ...
                                      <br><br>
                                        ...
                                        <div  class="form-group form-float float-right col-md-6">
                                            ...
                                            <a href="{{url('/admin/studentsleavelist')}}" class="btn btn-info waves-effect">BACK</a>
                                        </div>
