...
@section('master_exam_results', 'active')
@section('menuopena', 'active menu-is-opening menu-open')
<?php
$breadcrumb = [['url' => URL('/admin/home'), 'name' => 'Home', 'active' => ''], ['url' => '#', 'name' => 'Exam Results', 'active' => 'active']];
?>
@section('css')
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" style="font-size: 20px;">Exam Results </h4> 
                    <br>
                        <div class="row"> 
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-control course_id" name="class_id" id="class_id"
                                        onchange="loadClassSection(this.value);loadClassExaminations(this.value);">
                            ...
                            <div class="col-md-2">
                                ...
                                <button type="submit" class="btn signupBtn"
                                    ...
                                    onclick="loadExamResults()">Submit </button>
                            </div>
                  ...
                  <div class="card-body card-dashboard">
                    <div style="width: 100%; overflow-x: scroll; padding-left: -10px;">
                        <div class="table-responsicve">
                            <form id="frm-updatemarkentry" name="frm-updatemarkentry" method="post" action="{{url('/admin/update/all_exam_results')}}">
                            <table class="table table-striped table-bordered tblcountries" id="attendanceentries">
                              @include('admin.loadexamresults')
                            </table>
                            </form>
                        </div>
                    </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        function loadExamResults() {
            ...
            var request = $.ajax({
                type: 'post',
                url: " {{ URL::to('admin/load/exam_results') }}",
                headers: {
        ...
        function loadClassExaminations(val, selectedid, selectedval) {
                    ...
                    $.each(res.exams, function(key, value) {
                      ...
                      if (selid != null && selval != null) {
                        ...
                        $("#exam_id").append('<option value="' + value
                            .id + '" '+selected+' data-startdate="'+value.monthyear+'">' + value.exam_name + ' - ' +value.class_name +' - ' +value.section_name + '</option>');
                    });
                }
            });
        }
