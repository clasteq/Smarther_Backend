                ...
                <form id="edit-style-form" enctype="multipart/form-data"
                    ...
                    <div class="modal-body">
                        <div class="row">
                                ...
                                <div class="form-line">
                                    <select class="form-control " name="concession_category" id="concession_category" required>
                                        ...
                                        @if(!empty($get_concession_category))
                                            @foreach($get_concession_category as $ccat)
                            ...
                            <div class="form-group form-float float-left col-md-4">
                                <label class="form-label">Concession Remarks</label>
                                <div class="form-line">
                                    <input type="text" class="form-control " name="concession_remarks" id="concession_remarks" maxlength="200">
                                </div>
                            </div>
            ...
            studentDetails += `
                <div class="col-md-3 float-left feesborder" style="margin:2px;min-height: 200px !important;min-width: 280px ! important; max-width: 280px !important;    max-height: 200px !important; overflow-y: auto; overflow-x: clip;">
                    ...
                    <div class="d-flex termfees col-md-12">
                        ...
                        <div class="schoolproducts text-right col-md-5">
                            ${balanceInfo}
                        </div>
                        <div class=" col-md-3"> 
                    ...
                    <div class="d-flex termfees col-md-12">
                        ...
                        <div class=" col-md-3">${feeitemconcession}</div>
                    </div> 
                    <div class="d-flex termfees col-md-12">
                        <div class=" col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3 float-left">
                                    ...
                                    <label for="admissionAmount" class="form-label"><strong>${feeItem.fee_item.item_name}</strong></label> 
                                        <span><i class="fas fa-rupee-sign"></i> ${feeItem.amount}</span> 
                                </div>
                                <div class="col-md-3 float-left">
