                        ...
                        <div class="d-none" id="show_data">
                            ...
                            <section>
                                ...
                                class="post_pay_fee">
                                    ...
                                    <div class="container">
                                        <div class="row mt-3 mb-3" id="results">
                                ...
                                <div class="col-md-3">
                                    <div class="position-relative">
                                        <label
                                            ...
                                            <div class="form-group">
                                                <input type="date" name="cancel_date" class="form-control " placeholder="Select Date" required style="background-color: white;height:50px;">
                                            </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
    ...
    student.forEach(student => {
        ...
        student.fee_items.forEach(feeItem => {
            ...
            if(feeItem.concession_amount > 0) {
                concessionInfo = `<div class="form-group form-float float-left" > <span class="bg-success p-1">Concession: &#8377;${feeItem.concession_amount}</span>`;
                concessionInfo += `<span class="image img_1" onclick="deleteConcession('`+feeItem.id+`', '`+feeItem.fee_structure_id+`', '`+feeItem.concession_amount+`');"><i class="btn-delete fas fa-trash float-right delbtn"></i></span> </div>`;
            }
            if(feeItem.waiver_amount > 0) {
                waiverinfo = `<div class="form-group form-float float-left" >  <span class="bg-success p-1">Waiver: &#8377;${feeItem.waiver_amount}</span>`;
                waiverinfo += `<span class="image img_1" onclick="deleteWaiver('`+feeItem.id+`', '`+feeItem.fee_structure_id+`', '`+feeItem.waiver_amount+`');"><i class="btn-delete fas fa-trash float-right delbtn"></i></span> </div>`;
            }

            // Append fee item details to student details HTML max-width: 23%;
            studentDetails += `
                <div class="col-md-3 feesborder" style="margin:10px;">
        ...
        $('#edit_style_feerecep').on('click', function() {
                ...
                var options = {
                    ...
                    success: function(response) {
                        ...
                        $("#edit_style_feerecep").text('SUBMIT');
