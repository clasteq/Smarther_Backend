                                ...
                                <div class="col-md-3">
                                    <div class="position-relative">
                                        <label
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="cancel_date" class="form-control datetime-picker" placeholder="Select Date" required style="background-color: white;height:50px;">
                                            </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
...
function displayResults(student) {
    ...
    student.forEach(student => {
        ...
        student.fee_items.forEach(feeItem => {
            ...
            let balanceInfo = '';  let feeitemconcession = ''; 
            ...
            if(feeItem.paid_amount == 0 && student.fee_type != 1) {
                feeitemcancel = '<div class="feescollection float-left"> <i class="fas fa-trash" style="color: #f00;"  onclick="loadDeleteItem('+feeItem.id+', '+feeItem.fee_structure_id+')" ></i> </div>';
            }

            if(feeItem.concession_amount > 0) {
                concessionInfo = `<span class="bg-success p-1">Concession: &#8377;${feeItem.concession_amount}</span>`;
            }
            if(feeItem.waiver_amount > 0) {
                waiverinfo = `<span class="bg-success p-1">Waiver: &#8377;${feeItem.waiver_amount}</span>`;
            }
            ...
            studentDetails += `
                <div class="col-md-3 feesborder" style="margin:10px;">
                    <div class="d-flex justify-content-between feescheck">
                        <h4>${feeItem.fee_item.item_name} - <small>${paidLabel}</small></h4>
