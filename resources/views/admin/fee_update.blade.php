...
@section('scripts')
    ...
    <script>
                ...
                columns: [
                    {
                        ...
                        "render": function(data, type, row, meta) {
                            ...
                            var tid = data.id;
                            return '<a href="#" onclick="feeUpdateSection(' + tid +
                                ')" title="Update Section Fees"><i class="fas fa-edit"></i></a>';
                        },
        ...
        function feeUpdateSection(id) {
            swal({
                title : "",
                text : "Are you sure to update fees?",
                type : "warning",
            ...
            function(isConfirm){
                if (isConfirm) { 
                    var request = $.ajax({
                        type: 'post',
                        url: " {{ URL::to('/admin/edit/fee_update') }}",
                        headers: {
