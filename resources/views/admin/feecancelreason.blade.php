...
@section('master_fee_cancel', 'active')
...
<?php
$breadcrumb = [['url' => URL('/admin/home'), 'name' => 'Home', 'active' => ''], ['url' => '#', 'name' => 'Fee Cancel Reason', 'active' => 'active']];
?><?php 
...
<style>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 style="font-size:20px;" class="card-title"><!-- Fee Cancel Reason -->
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="smallModalLabel">Add Cancel Reason</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>

                <form id="style-form" enctype="multipart/form-data" action="{{ url('/admin/save/fee_cancel_reason') }}"
                    method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group form-float float-left col-md-6">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" name="cancel_reason" required minlength="1"
                                        maxlength="200">
                                </div>
                            </div>
                            <div class="form-group form-float float-left col-md-6">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control "name="reason_code"
    ...
    <div class="modal fade in" id="smallModal-2" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="smallModalLabel">Edit Cancel Reason</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>

                <form id="edit-style-form" enctype="multipart/form-data" action="{{ url('/admin/save/fee_cancel_reason') }}"
                    method="post">
                            ...
                            <div class="form-group form-float float-left col-md-6">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control "name="cancel_reason"
                                        id="edit_cancel_reason" required minlength="1" maxlength="200">
                                </div>
                            </div>
                            <div class="form-group form-float float-left col-md-6">
                                <label class="form-label">Reason Code</label>
                                <div class="form-line">
                                    <input type="text" class="form-control "name="reason_code"
                                        id="edit_reason_code" required minlength="1" maxlength="200">
                                </div>
                            </div>
                            <div class="form-group form-float float-left col-md-6">
                                <label class="form-label">Position</label>
    ...
    <script>
        ...
        $(function() {
                ...
                var table = $('#example1').DataTable({
                    ...
                    "lengthChange": false,
                    "ajax": {
                        "url": "{{URL('/')}}/admin/fee_cancel_reason_data/datatables/", 
                        data: function(data) {
                        ...
                        { data: 'status'},
                        {
                            ...
                            "render": function(data, type, row, meta) {
                                ...
                                return '<a href="#" onclick="loadSection(' + tid +
                                    ')" title="Edit Cancel reason"><i class="fas fa-edit"></i></a> <a href="#" onclick="deletedata(' + tid +
                                    ')" title="Delete  Cancel reason"><i class="fas fa-trash"></i></a>';
                            },
        ...
        function loadSection(id) {
            ...
            var request = $.ajax({
                type: 'post',
                url: " {{ URL::to('/admin/edit/fee_cancel_reason') }}",
                headers: {
            ...
            request.done(function(response) {
                ...
                $('#edit_cancel_reason').val(response.data.cancel_reason);
                $('#edit_reason_code').val(response.data.reason_code);
        ...
        function deletedata(id){
            ...
            function(isConfirm){
                if (isConfirm) {
                    var request = $.ajax({
                        type: 'post',
                        url: " {{URL::to('/admin/delete/fee_cancel_reason')}}",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        data:{
