...
@section('master_feecategory', 'active')
...
<?php
$breadcrumb = [['url' => URL('/admin/home'), 'name' => 'Home', 'active' => ''], ['url' => '#', 'name' => 'Fee Category', 'active' => 'active']];
?>
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 style="font-size:20px;" class="card-title">Fee Category
    ...
    <div class="modal fade in" id="smallModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="style-form" enctype="multipart/form-data" action="{{ url('/admin/save/fee_category') }}"
                    method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group form-float float-left col-md-6">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" name="category_name" required minlength="1"
                                        maxlength="200">
                                </div>
                            </div>
                            <div class="form-group form-float float-left col-md-6">
    ...
    <div class="modal fade in" id="smallModal-2" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="edit-style-form" enctype="multipart/form-data" action="{{ url('/admin/save/fee_category') }}"
                    method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group form-float float-left col-md-6">
                                <label class="form-label">Category Name</label>
                                <div class="form-line">
                                    <input type="text" id="edit_category_name"  class="form-control" name="category_name" required minlength="1"
                                        maxlength="200">
                                </div>
                            </div>
                            <div class="form-group form-float float-left col-md-6">
    ...
    <script>
        ...
        $(function() {
                ...
                var table = $('#example1').DataTable({
                    ...
                    "lengthChange": false,
                    "ajax": {
                        "url": "{{URL('/')}}/admin/fee_category_data/datatables/", 
                        data: function(data) {
                    ...
                    columns: [
                        ...
                        { data: 'position', name:'fee_categories.position'},
                        { data: 'status', name:'fee_categories.status'},
                        {
                            data: null,
                            "render": function(data, type, row, meta) {
                                ...
                                return '<a href="#" onclick="loadSection(' + tid +
                                    ')" title="Edit Category"><i class="fas fa-edit"></i></a> <a href="#" onclick="deletedata(' + tid +
                                    ')" title="Delete Fee Category"><i class="fas fa-trash"></i></a>';
                            },
        ...
        function loadSection(id) {
            ...
            var request = $.ajax({
                type: 'post',
                url: " {{ URL::to('/admin/edit/fee_category') }}",
                headers: {
            ...
            request.done(function(response) {
                ...
                $('#edit_account_id').val(response.data.account_id);
        ...
        function deletedata(id){
            ...
            function(isConfirm){
                if (isConfirm) {
                    var request = $.ajax({
                        type: 'post',
                        url: " {{URL::to('/admin/delete/fee_category')}}",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        data:{
