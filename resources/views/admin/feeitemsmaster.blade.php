...
@section('master_fee_items', 'active')
...
<?php
$breadcrumb = [['url' => URL('/admin/home'), 'name' => 'Home', 'active' => ''], ['url' => '#', 'name' => 'Fee Items', 'active' => 'active']];
?>
@section('content')
...
<style>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 style="font-size:20px;" class="card-title">Fee Items
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="smallModalLabel">Add Fee Items</h4>
                </div>

                <form id="style-form" enctype="multipart/form-data" action="{{ url('/admin/save/fee_items') }}"
                    method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group form-float float-left col-md-6">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" name="item_name" required minlength="1"
                                        maxlength="200">
                                </div>
                            </div>
                            <div class="form-group form-float float-left col-md-6">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" name="item_code" required minlength="1"
                                        maxlength="10">
                                </div>
                            </div>
    ...
    <div class="modal fade in" id="smallModal-2" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="smallModalLabel">Edit Fee Items</h4>
                </div>

                <form id="edit-style-form" enctype="multipart/form-data" action="{{ url('/admin/save/fee_items') }}"
                    method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group form-float float-left col-md-6">
                                <label class="form-label">Item Name</label>
                                <div class="form-line">
                                    <input type="text" class="form-control" name="item_name" id="edit_item_name" required minlength="1"
                                        maxlength="200">
                                </div>
                            </div>
                            <div class="form-group form-float float-left col-md-6">
                                <label class="form-label">Item Code</label>
                                <div class="form-line">
                                    <input type="text" class="form-control" name="item_code" id="edit_item_code" required minlength="1"
                                        maxlength="10">
                                </div>
                            </div>
                            <div class="form-group form-float float-left col-md-6">
    ...
    <script>
        ...
        $(function() {
                ...
                var table = $('#example1').DataTable({
                    ...
                    "lengthChange": false,
                    "ajax": {
                        "url": "{{URL('/')}}/admin/fee_items_data/datatables/", 
                        data: function(data) {
                        ...
                        { data: 'status'},
                        {
                            ...
                            "render": function(data, type, row, meta) {
                                ...
                                return '<a href="#" onclick="loadSection(' + tid +
                                    ')" title="Edit Item"><i class="fas fa-edit"></i></a> <a href="#" onclick="deletedata(' + tid +
                                    ')" title="Delete Fee Item"><i class="fas fa-trash"></i></a>';
                            },
        ...
        function loadSection(id) {
            ...
            var request = $.ajax({
                type: 'post',
                url: " {{ URL::to('/admin/edit/fee_items') }}",
                headers: {
        ...
        function deletedata(id){
            ...
            function(isConfirm){
                if (isConfirm) {
                    var request = $.ajax({
                        type: 'post',
                        url: " {{URL::to('/admin/delete/fee_items')}}",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        data:{
