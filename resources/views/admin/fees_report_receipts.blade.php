    ...
    <script>
        ...
        $(function() { 
            ...
            var table = $('.tblcountries').DataTable({
                ...
                responsive: false,
                "ajax": {
                    "url":"{{URL('/')}}/admin/fees_receipts_report/datatables/",  
                    data: function ( d ) { 
                        var batch = $('#batch').val();
                ...
                buttons: [
                    {
                        ...
                        action: function (e, dt, node, config) {
                            $.ajax({
                                "url":"{{URL('/')}}/admin/fees_receipts_report_excel/",   
                                "data": dt.ajax.params(),
                                "type": 'get',
                                "success": function(res, status, xhr) {
                                    ...
                                    tempLink.setAttribute('download', 'Fee_Receipts_Report.xls');
                                    tempLink.click();
                                }
                            });
                        }
