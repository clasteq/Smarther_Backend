...
@section('master_paymentmode', 'active')
...
<?php
$breadcrumb = [['url' => URL('/admin/home'), 'name' => 'Home', 'active' => ''], ['url' => '#', 'name' => 'Payment Mode', 'active' => 'active']];
?>
@section('content')
...
<style>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 style="font-size:20px;" class="card-title">Payment Mode
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="smallModalLabel">Add Payment Mode</h4>
                </div>

                <form id="style-form" enctype="multipart/form-data" action="{{ url('/admin/save/payment_mode') }}"
                    method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group form-float float-left col-md-6">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control" name="payment_mode" required minlength="1"
                                        maxlength="200">
                                </div>
                            </div>
                            <div class="form-group form-float float-left col-md-6">
    ...
    <div class="modal fade in" id="smallModal-2" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="smallModalLabel">Edit Payment Mode</h4>
                </div>

                <form id="edit-style-form" enctype="multipart/form-data" action="{{ url('/admin/save/payment_mode') }}"
                    method="post">
                            ...
                            <div class="form-group form-float float-left col-md-6">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control "name="payment_mode"
                                        id="edit_payment_mode" required minlength="1" maxlength="200">
                                </div>
                            </div>
                            <div class="form-group form-float float-left col-md-6">
                                <label class="form-label">Position</label>
    ...
    <script>
        ...
        $(function() {
                ...
                var table = $('#example1').DataTable({
                    ...
                    "lengthChange": false,
                    "ajax": {
                        "url": "{{URL('/')}}/admin/payment_mode_data/datatables/", 
                        data: function(data) {
                        ...
                        { data: 'status'},
                        {
                            ...
                            "render": function(data, type, row, meta) {
                                ...
                                return '<a href="#" onclick="loadSection(' + tid +
                                    ')" title="Edit Payment mode"><i class="fas fa-edit"></i></a> <a href="#" onclick="deletedata(' + tid +
                                    ')" title="Delete Payment mode"><i class="fas fa-trash"></i></a>';
                            },
        ...
        function loadSection(id) {
            ...
            var request = $.ajax({
                type: 'post',
                url: " {{ URL::to('/admin/edit/payment_mode') }}",
                headers: {
            ...
            request.done(function(response) {
                ...
                $('#edit_payment_mode').val(response.data.name);
        ...
        function deletedata(id){
            ...
            function(isConfirm){
                if (isConfirm) {
                    var request = $.ajax({
                        type: 'post',
                        url: " {{URL::to('/admin/delete/payment_mode')}}",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        data:{
