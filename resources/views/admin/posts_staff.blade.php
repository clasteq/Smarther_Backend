...
?> 
@if((isset($session_module['Staff Posts']) && ($session_module['Staff Posts']['list'] == 1)) || ($user_type == 'SCHOOL'))
...
<section class="content">
        ...
        <div class="content container-fluid">
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header">Posts for Staffs
                        @if((isset($session_module['Staff Posts']['add']) && ($session_module['Staff Posts']['add'] == 1)) || ($user_type == 'SCHOOL'))
                        <a href="{{url('/admin/addpoststaff')}}" id="addbanner"><button class="btn btn-primary" style="float: right;">Add</button></a> 
                        @endif
                        <div class="row">
            ...
            <input type="hidden" name="pagename" id="pagename" value="communication_posts_staff">
            <input type="hidden" name="loadsection" id="loadsection" value=".posts .pagination_section">
                    ...
                    @include('admin.posts_staff_list')   
                    </div>  
                </div>
            </div>
        </div>
    ...
    <script>  
            ...
            swal({
                ...
                if(inputValue===false) {
                      ...
                      $( ".confirm.btn.btn-lg.btn-primary" ).trigger( "click" );
                        ...
                        var request = $.ajax({
                        type: 'post',
                        url: " {{URL::to('admin/delete/posts_staff')}}",
                        headers: {
            ...
            swal({
                ...
                if(inputValue===false) {
                      ...
                      $( ".confirm.btn.btn-lg.btn-primary" ).trigger( "click" );
                        ...
                        var request = $.ajax({
                        type: 'post',
                        url: " {{URL::to('admin/update/posts_staff')}}",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        data:{
        ...
        function openpoststatus(pid) {
            ...
            var tablefee = $('.tblpoststatus').DataTable({
                ...
                responsive: false,
                "ajax": {
                    "url":"{{URL('/')}}/admin/posts_staff_status/datatables?id="+pid, 
                },
                columns: [
                        ...
                        action: function (e, dt, node, config) {
                            $.ajax({
                                ...
                                "success": function(res, status, xhr) {
                                    ...
                                    tempLink.setAttribute('download', 'PostStaffStatus.xls');
                                    tempLink.click();
                                }
                            });
                        }
