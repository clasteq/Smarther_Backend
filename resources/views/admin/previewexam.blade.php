...
<?php
$breadcrumb = [['url' => URL('/admin/home'), 'name' => 'Home', 'active' => ''], ['url' => '#', 'name' => 'View Exams', 'active' => 'active']];
?>
@section('content')
    <style type="text/css">
        .blue {
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 style="font-size:20px;" class="card-title">View Exam
                        </h4>
                            ...
                            <div style="width: 100%; overflow-x: scroll; padding-left: -10px;">
                                {{-- <div class="table-responsicve"> --}}
                                    ...
                                    <div class="col-md-12" id="timetableentries">
                                        @include('admin.previewloadexamlist')
                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        function loadexamtable() {
            ...
            var request = $.ajax({
                type: 'post',
                url: " {{ URL::to('admin/viewload/exams') }}",
                headers: {
