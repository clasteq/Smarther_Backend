                                ...
                                <div class="row">
                                    ...
                                    @if(!empty($qb['new_test_items']) && count($qb['new_test_items'])>0)
                                        @foreach($qb['new_test_items'] as $no=>$papers) 
                                            ...
                                            <button onclick="CreatePDFfromHTML('exportContent{{$no}}','{{$testname}}');" class="btn btn-info waves-effect exportContent" data-id="exportContent{{$no}}" data-no="{{$no+1}}">{{$no+1}}. Export as .pdf</button>
...
@section('scripts') 
    ...
    <script type="text/javascript">
        function CreatePDFfromHTML(element, filename = '') {
