...
?> 
@if((isset($session_module['Remarks']) && ($session_module['Remarks']['list'] == 1)) || ($user_type == 'SCHOOL'))
    ...
    <script> 
        $(function() {
            ...
            var table = $('.tblcountries').DataTable({
                ...
                responsive: false,
                "ajax": {
                    "url":"{{URL('/')}}/admin/remarks/datatables/", 
                    data: function ( d ) {
                        ...
                        action: function (e, dt, node, config) {
                            $.ajax({
                                ...
                                "success": function(res, status, xhr) {
                                    ...
                                    tempLink.setAttribute('download', 'Remarks.xls');
                                    tempLink.click();
                                }
                            });
                        }
