...
@section('master_staffgroup', 'active')
...
<?php
$breadcrumb = [['url'=>URL('/admin/home'), 'name'=>'Home', 'active'=>''], ['url'=>'#', 'name'=>'Staff Group', 'active'=>'active']];
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4 style="font-size:20px;" class="card-title">Staff Group
                    @if((isset($session_module['Staff Group']) && ($session_module['Staff Group']['add'] == 1)) || ($user_type == 'SCHOOL'))
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group form-float float-left col-md-12">
                                ...
                                <div class="form-line">
                                    <select class="form-control select2" name="student_id[]" required multiple>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group form-float float-left col-md-12">
                                <label class="form-label">Students</label>
                                <div class="form-line">
                                    <select class="form-control select2" name="student_id[]"id="student_id"  required multiple>
                                        @foreach($get_student as $student)
                                        <option value="{{$student->user_id}}">{{$student->is_student_name}}-({{$student->is_class_name}}-{{$student->is_section_name}})</option>
                                        @endforeach  
                                    </select>
        ...
        function loadGroup(id){
            ...
            request.done(function (response) {
                ...
                if($.trim(response.data.members) != '') {
                    ...
                    $('#student_id').val(members).trigger('change');
