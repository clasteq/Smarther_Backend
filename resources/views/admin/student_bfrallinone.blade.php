                    ...
                    <div class="row">
                        <div class="container-fluid">
                            <ul class="nav nav-tabs" id="myTabs">
                                <li class="active"><a href="#basic_details" data-url="basic">Basic Details</a></li>
                                ...
                                <li><a href="#reward_details" data-url="reward">Rewards</a></li>
                            </ul>
                          
                            <div class="tab-content">
                                <div class="tab-pane active" id="basic_details">This is the home pane...</div>
                                <div class="tab-pane" id="additional_details"></div>
                                <div class="tab-pane" id="sibling_details"></div>
                                <div class="tab-pane" id="reward_details"></div>
                            </div>
                        </div>
                    </div>
                </div>
