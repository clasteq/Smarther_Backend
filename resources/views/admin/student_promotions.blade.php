...
<?php  
$breadcrumb = [['url'=>URL('/admin/home'), 'name'=>'Home', 'active'=>''], ['url'=>'#', 'name'=>'Student Promotions', 'active'=>'active']];
?>
@section('css')
            ...
            if(section_id == ''){
                ...
                if(lengthchked > 0 ) {
                    ...
                    $("input:checkbox:checked").each(function() {
                     ...
                     $.ajax({
                        "url": "{{URL::to('/admin/update/promotions')}}",
                        type: 'post',
                        headers: {
...
swal('Oops', 'Something went to wrong.', 'error');
                    ...
                    swal('Oops',"Please Select Students for promotion",'warning');
                    return false;
                }
             } 
