                  ...
                  <div class="card-body card-dashboard">
                    <div style="width: 100%; overflow-x: scroll; padding-left: -10px;">
                        <div class="table-responsicve" id="attendanceentries">
                              ...
                              @include('admin.loadstudentsattendancerep')
...
@section('scripts')
    <script type="text/javascript">
        ...
        function putattendance(studentid, mode, day,session,obj) {
            ...
            var request = $.ajax({
                type: 'post',
                url: " {{ URL::to('admin/update/studentattendancerep') }}",
                headers: {
        ...
        function loadStudentattendance() {
            ...
            var request = $.ajax({
                type: 'post',
                url: " {{ URL::to('admin/load/studentattendancerep') }}",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
                data: {
        ...
        function excelFunction(slot) {
            ...
            $.ajax({
                "url":"{{URL('/')}}/admin/attendencereport/excel/",   
                type: 'get',
                data: {
                    monthyear: monthyear,
                    slot: slot
