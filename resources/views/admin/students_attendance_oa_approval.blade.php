...
@section('master_oa_student_attendance_approval', 'active')
                        ...
                        <div class="row"> 
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control"
                                    ...
                                    name="cdate" id="cdate" value="{{ $cdate }}" min="{{date('Y-m-d')}}">
                            </div>
                            <div class="col-md-4">
                ...
                <div class="card-content collapse show">
                  <div class="card-body card-dashboard">
                    <div style="width: 100%; overflow-x: scroll; padding-left: -10px;">
                        ...
                        <form method="post" name="frm_attendanceentries" id="frm_attendanceentries" action="{{URL::to('/admin/approve/oaAttendance')}}">{{csrf_field()}}
                            <input type="hidden" name="attdate" id="attdate">
                        <div class="clearfix"> &nbsp;</div> 
                        <input type="checkbox" name="att_chk" onclick="checkSession()" id="att_chk" > Select All
                        ...
                        <div class="clearfix"> <button class="btn btn-success" id="approveOaAttendance" type="sumbit">Approve</button></div>
                        </form>
                    </div>
                  </div>
                </div> 
        ...
        $(function() {
            ...
            var table = $('.tblcountries').DataTable({
                ...
                "ajax": {/*$total = $oa_boys + $oa_girls;*/
                    "url":"{{URL('/')}}/admin/oa_student_attendance_approval/datatables/",   
                    data: function ( d ) {
                        var cdate  = $('#cdate').val();
                ...
                columns: [  
                    {
                        ...
                        "render": function ( data, type, row, meta ) { 
                            ...
                            return '<input type="checkbox" class="att_section" name="att_section['+class_id+']['+section_id+']" value="att_section_'+class_id+'_'+section_id+'" id="att_section" checked>';
                    ...
                    }, 
                    {
                        ...
                        "render": function ( data, type, row, meta ) { 
                            ...
                            var url = "{{URL('/')}}/admin/student_dailyattendance?date="+cdate+"&class_id="+class_id+"&section_id="+section_id;
                            return  ' <a href="'+url+'" target="_blank" title="View attendance"><i class="fas fa-eye"></i></a> ';
                    ...
                    }, 
                    {
                        ...
                        "render": function ( data, type, row, meta ) { 
                            ...
                            if(is_approved == 'Approved') {
                                app = '<i class="fa fa-check greentickbox"></i>';
                            }   else {
                                app = '<i class="fa fa-times redcrossbox"></i>';
                            }
