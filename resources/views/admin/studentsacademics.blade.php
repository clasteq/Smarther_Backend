...
@section('master_classmappings', 'active')
@section('menuopena', 'active menu-is-opening menu-open')
<?php
$breadcrumb = [['url' => URL('/admin/home'), 'name' => 'Home', 'active' => ''], ['url' => '#', 'name' => 'Student Class Mappings', 'active' => 'active']];
?>
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" style="font-size: 20px;">Students Class Mappings
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="smallModalLabel">Add Student Class Mappings</h4>
                </div>

                <form id="style-form" enctype="multipart/form-data" action="{{ url('/admin/save/studentacademics') }}"
                    method="post">
                            ...
                            <div class="form-group form-float float-left col-md-6">
                                ...
                                <div class="form-line">
                                    <select class="form-control course_id" name="class_id"
                                        onchange="loadClassSection(this.value)" id="class_dropdown" required>
    ...
    <div class="modal fade in" id="smallModal-2" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="smallModalLabel">Edit Student Class Mappings</h4>
                </div>

                <form id="edit-style-form" enctype="multipart/form-data" action="{{ url('/admin/save/studentacademics') }}"
                    method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                        	<div class="form-group form-float float-left col-md-6">
                                <label class="form-label">Student <span class="manstar">*</span></label>
                                <div class="form-line">
                                    <input type="hidden" class="form-control"   name="user_id" id="new_user">
                                    <select  class="form-control" readonly id="edit_user_id" required disabled>
                                        <option value="">Select Student</option>
                                        @if (!empty($students))
                                            @foreach ($students as $student)
                                                <option value="{{ $student->id }}">{{ $student->name }} {{ $student->last_name }}
...
@section('scripts')
    ...
    <script>
        ...
        $(function() {
            ...
            // $( "#academic_year" ).datepicker({changeDay:false, changeMonth:false, changeYear:true})
            ...
            var table = $('.tblcountries').DataTable({
                ...
                responsive: false,
                "ajax": {
                    "url": '{{ route('student_academics.data') }}',
                    data: function ( d ) {
        ...
        function loadStudentAcademics(id) {
            ...
            request.done(function(response) {
                ...
                $('#new_user').val(response.data.user_id);
                ...
                // loadclassandsection(response.data.user_id,response.data.class_id,response.data.section_id)
        ...
        // function loadclassandsection(val, selectedid, selectedval){
        ...
        //     $("#class_dropdown,#edit_class_id").html('');
        //     $("#section_dropdown").html('');
        //     $.ajax({
        //         url: "{{ url('admin/fetch-student-class') }}",
        //         type: "POST",
        //         data: {
        ...
        //             //         $("#class_dropdown").val(value.class_id);
        //             //         $("#section_dropdown").val(value.section_id);
        //             //     });
        //         }
        //     });
