    ...
    <script>
        $(function() {
            var table = $('.tblcountries').DataTable({
                ...
                responsive: false,
                "ajax": {
                    "url":"{{URL('/')}}/admin/studenttestattempts/datatables/", 
                    data: function ( d ) {
                ...
                columns: [
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var tid = data.test_id; var uid = data.user_id;
                            var vurl = "{{URL('/')}}/admin/view/studentstestattempts?uid="+uid+"&tid="+tid; 
                           return  '<a href="'+vurl+'" targer="_blank"  title="View Test Attempts"><i class="fas fa-eye"></i></a>';
