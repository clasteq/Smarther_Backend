              ...
              <div class="card">
                <div class="card-header">
                  <h4 style="font-size:20px;" class="card-title">Test List Papers
                    <a href="{{URL('/')}}/admin/auto/testlist"><button id="addbtn" class="btn btn-primary" style="float: right;">Create Test</button></a>  
                  </h4>        
                  <div class="row">
    ...
    <script> 
        $(function() { 
            var table = $('.tblcountries').DataTable({
                ...
                responsive: false,
                "ajax": {
                    "url":"{{URL('/')}}/admin/testlistpapers/datatables/",   
                    data: function ( d ) {
                ...
                columns: [ 
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var vurl = "{{URL('/')}}/admin/view/testlistpapers?id="+tid;
