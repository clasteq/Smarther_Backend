                                ...
                                <div class="row"><div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group form-float float-left col-md-6">
                                            ...
                                            <div class="form-line"> <input type="text" class="form-control col-sm-6" name="test_name" id="test_name" value="{{$test_name}}" required style="width:100%;">
                                            </div>
                                        </div>
                                        <div class="form-group form-float float-left col-md-6">
