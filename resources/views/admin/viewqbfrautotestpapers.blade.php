...
<?php
$breadcrumb = [['url'=>URL('/admin/home'), 'name'=>'Home', 'active'=>''], ['url'=>URL('/admin/testlistpapers'), 'name'=>'Tests', 'active'=>''], ['url'=>'#', 'name'=>'Auto Test Creation', 'active'=>'active'] ];
?>
@section('content')
 <?php
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row"><div class="col-md-12">
                                    <form name="frm_questionbank" id="frm_questionbank" method="post" action="{{url('/admin/save/qbautotestpapers')}}">
                                    {{csrf_field()}}
                                    <div class="row">
                ...
                var options = {
                    ...
                    success: function (response) {
                        ...
                        if (response.status == "SUCCESS") {
                           ...
                           window.location.href = "{{URL('/')}}/admin/testlistpapers";
