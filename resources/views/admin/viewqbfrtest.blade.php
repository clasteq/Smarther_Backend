                            ...
                            <div class="card-body">
                                ...
                                <div class="row"><div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="section_id" id="section_id" value="{{$section_ids}}">
                                        ...
                                        <div class="form-group form-float float-left col-md-6">
                                            ...
                                            <div class="form-line">  {{$section_names}}
                                            </div>
                                        </div>
                                        <div class="form-group form-float float-left col-md-6">
                                        ...
                                        <div class="form-group form-float float-left col-md-6">
                                            ...
                                            <div class="form-line">
                                            <input class="col-md-6 form-control" required type="text" autocomplete="off" name="test_mark" id="test_mark"  onkeypress="return isNumber(event)"  onkeyup="floatmark();" /> 
                                            </div>
                                        </div>
                                        <div class="form-group form-float float-left col-md-6">
                                        ...
                                        <div class="form-group form-float float-right col-md-12 position-fixed-center" id="floattotalmarks">Total Test Mark:  
                                        </div>
                                        <div class="form-group form-float float-right col-md-12 position-fixed-center" id="floatenteredmarks" style="top:60% !important;">Total Entered Mark:  
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    @if(!empty($items) && count($items)>0) 
                                        ...
                                        ?>
                                           ...
                                           <input class="newopration_{{$qtype['question_bank_id']}}_{{$qtype['question_type_id']}} operation" type="checkbox" data-qbid="{{$qtype['question_bank_id']}}"  data-qtyid="{{$question_type}}" data-qtype="{{$qtype['question_type']}}"
                                            ...
                                            <?php $item = $items['qb_items']; //echo "<pre>"; print_r($item); echo "</pre>";exit;?>
                                                <div class="row">
