...
@section('waiver_fee_report', 'active')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 style="font-size: 20px;" class="card-title"><!-- Fee Waiver Report   --></h4>
                        <div class="row">   
    ...
    <script>
        ...
        $(function() {
            ...
            var table = $('.tblcountries').DataTable({
                ...
                responsive: false,
                "ajax": {
                    "url":"{{URL('/')}}/admin/waiver_fee_report/collection/datatables/",  
                    data: function ( d ) { 
                        var batch = $('#batch').val();
                ...
                buttons: [
                    {
                        ...
                        action: function (e, dt, node, config) {
                            $.ajax({
                                "url":"{{URL('/')}}/admin/waiver_fee_report/collection_excel/",   
                                "data": dt.ajax.params(),
                                "type": 'get',
                                "success": function(res, status, xhr) {
                                    ...
                                    tempLink.setAttribute('download', 'Fee_Waiver_Report.xls');
                                    tempLink.click();
                                }
                            });
                        }
