...
<?php
$breadcrumb = [['url'=>URL('/teacher/home'), 'name'=>'Home', 'active'=>''], ['url'=>'#', 'name'=>'Categories', 'active'=>'active']];
?>
@section('content')
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="style-form" enctype="multipart/form-data"
                                  action="{{url('/teacher/save/categories')}}"
                                  method="post">
    ...
    <script>
        ...
        $(function() {
            var table = $('.tblcountries').DataTable({
                ...
                responsive: false,
                "ajax": {
                    "url":"{{URL('/')}}/teacher/categories/datatables/", 
                    data: function ( d ) {
        ...
        function loadCategory(id){
            ...
            var request = $.ajax({
                type: 'post',
                url: " {{URL::to('/teacher/edit/categories')}}",
                headers: {
