            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 style="font-size: 20px;" class="panel-title">Edit Students Test
                                </h4>
                                <div class="row"><div class="col-md-12">
                                    ...
                                    @if(!empty($qb['test_items']) && count($qb['test_items'])>0)
                                        ...
                                        @if(isset($qtype))
                                            ...
                                            @foreach($qtype['tt_items'] as $item) <?php //echo "<pre>"; print_r($item); exit;?>
                                                ...
                                                {{-- <input type="text"  name="noofquest[{{$qtype['question_type_id']}}_{{$qtype['question_bank_id']}}]" class="form-control noofquest newnoofquest_{{$qtype['question_bank_id']}}_{{$qtype['question_type_id']}}"  id="noofquest" data-qbid="{{$qtype['question_bank_id']}}"  data-qtyid="{{$qtype['question_type_id']}}" value="{{count($qtype['qb_items'])}}"> --}}
                                    ...
                                    <div class="form-group form-float float-left col-md-2">
                                        <input type="text" name="grade" id="grade" value="{{$qb['student_grade']}}" required class="col-md-6  float-left">
                                    </div>
                                ...
                                <a href="{{url('/teacher/teacher_studentstestlist')}}" class="btn btn-info waves-effect">BACK</a>
                            </div>
                        </div>
                    </div>
                </div>
