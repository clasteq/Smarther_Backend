...
<?php  
$breadcrumb = [['url'=>URL('/teacher/home'), 'name'=>'Home', 'active'=>''], ['url'=>URL('/teacher/testlist'), 'name'=>'Tests', 'active'=>''], ['url'=>'#', 'name'=>'Edit Test', 'active'=>'active'] ];
?>
@section('content')
                        ...
                        <div class="card"> 
                            <div class="card-body">
                                ...
                                <div class="row"><div class="col-md-12"> 
                                        ...
                                        <form name="frm_questionbank" id="frm_questionbank" method="post" action="{{url('/teacher/update/updatetest')}}">
                                            <div class="row">
                                            {{csrf_field()}}
