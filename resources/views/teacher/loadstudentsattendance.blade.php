...
?>
        ...
        @for($i=1; $i<=$lastdate; $i++)
            ...
            @endif
        @endfor 
        <td><a target="_blank" href="{{URL('/')}}/teacher/entryattendance/{{$student['enc_id']}}/{{$monthyear}}/{{$class_id}}/{{$section_id}}" style="padding-top:0px;"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
        </tr>
    @endforeach
</tbody>
@else 
