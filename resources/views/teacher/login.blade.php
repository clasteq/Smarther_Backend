...
<head>
  ...
  <title>{{ config("constants.site_name") }} | Teacher Log in</title>
    ...
    <div class="login-box" style="margin-top:10%; margin-left: 40%;">
      ...
      <div class="card">
        <div class="card-body login-card-body">
          <p style="color:#007bff;font-size:20px;" class="login-box-msg">Login to Your Account</p>
          <p style="font-size:15px;" class="login-box-msg">Please put your credentials</p>

          <form action="{{ url('teacher/login') }}" method="post" id="login-form">
            {{csrf_field()}}
            <div class="input-group mb-3">
              <input type="text" class="form-control" placeholder="Mobile" name="email" id="email" >
        ...
        var options = {
            ...
            success: function (response) {
                ...
                if (response.status == "SUCCESS") {
                    ...
                    window.location.href = "{{URL::to('teacher/home')}}";
