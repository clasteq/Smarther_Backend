...
<?php  
$breadcrumb = [['url'=>URL('/teacher/home'), 'name'=>'Home', 'active'=>''], ['url'=>'#', 'name'=>'Edit Student Attendance', 'active'=>'active']];
?>
@section('content') 
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4  style="font-size: 20px;" class="card-title">Students Attendance Entry
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label style="padding-bottom: 10px;">Select Month</label>
                         <input type="month" class="form-control" style="margin: 0px 0 23px !important;padding: 18px 22px !important;" name="monthyear" id="monthyear" value="{{$monthyear}}">
                    </div>
                    <div class="col-md-2">
                ...
                <div class="row">
                    <table class="table table-bordered">
                      ...
                      <tbody style="text-align: center;" id="attendanceentries">
                        @include('teacher.studentsattendanceentries',['player'=>$player])
                        <tr>
                      </tbody>
                    </table>
                </div>
...
<script type="text/javascript">
    $(function() {
        ...
        function putattendance(student_id, mode, day, obj){
            ...
            var request = $.ajax({
                type: 'post',
                url: " {{URL::to('teacher/update/studentattendance')}}",
                headers: {
