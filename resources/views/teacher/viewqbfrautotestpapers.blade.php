...
<?php
$breadcrumb = [['url'=>URL('/teacher/home'), 'name'=>'Home', 'active'=>''], ['url'=>URL('/teacher/testlistpapers'), 'name'=>'Tests', 'active'=>''], ['url'=>'#', 'name'=>'Auto Test Creation', 'active'=>'active'] ];
?>
@section('content')
 <?php
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 style="font-size:20px;" class="panel-title">Auto Test Papers Creation
                                </h4>
                                <div class="row"><div class="col-md-12">
                                    <form name="frm_questionbank" id="frm_questionbank" method="post" action="{{url('/teacher/save/qbautotestpapers')}}">
                                    {{csrf_field()}}
                                    <div class="row">
                                    <input type="hidden" name="class_id" id="class_id" value="{{$qbank[0]->class_id}}">
                                        ...
                                        <div class="form-group form-float float-left col-md-6">
                                            <label class="form-label">Total No of papers</label>
                                            <div class="form-line"> <input class="col-md-6 form-control" required type="text" autocomplete="off" name="no_of_papers" id="no_of_papers" onkeypress="return isNumber(event)" min="1" maxlength="3" /> 
                                            </div>
                                        </div>
                ...
                var options = {
                    ...
                    success: function (response) {
                        ...
                        if (response.status == "SUCCESS") {
                           ...
                           window.location.href = "{{URL('/')}}/teacher/testlistpapers";
