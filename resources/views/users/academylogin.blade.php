            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="my-account-content">
                        <form class="my-account-form" id="user-login-form" action="{!! url('academylogin') !!}" method="POST"  enctype="multipart/form-data" style="margin-top: -230px;background: #fff; border-radius: 35px 36px 0px 0px;">

				        {{csrf_field()}} 
                            <h2 style="padding-bottom:20px; font-style: normal; text-align: center;"><span class="text-green">LOGIN </span> AS ACADEMY</h2>
                           ...
                           <div class="row">
                                <div class="col-md-12 ">
                                    <p style="padding: 15px 0px;">Don't have an account? <span style="text-decoration:underline; cursor: pointer;" class="text-green"  onclick="window.location.href='{{URL('/')}}/registeracademy'"  >Register Now</span></p> 
                                </div>
