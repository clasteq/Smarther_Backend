            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="my-account-content">
                        ...
                        <form id="registerSchoolForm" action="{!! url('signupacademy') !!}" class="my-account-form" style="margin-top: -230px;background: #fff; border-radius: 35px 36px 0px 0px;" method="POST"> 
                        	{{csrf_field()}}
                            <h2 style="padding-bottom:20px; font-style: normal; text-align: center;"><span class="text-green">REGISTER </span> AS ACADEMY</h2>
                            <p   style="padding-bottom:20px; font-style: normal; text-align: center;" > JOIN OUR TRAINING CLUB AND RISE TO NEW CHALLENGE </p>
                            
                            <div class="main">

                                <div class="col-md-6 float-left">
                                <label for="username"> Academy Name *</label>
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    <p style="padding: 15px 0px;">Already have an account? <span style="text-decoration:underline;cursor: pointer;" class="text-green"  onclick="window.location.href='{{URL('/')}}/academylogin'"  >Login</span></p> 
                                </div>
