            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="my-account-content">
                        ...
                        <form id="registerSchoolForm" action="{!! url('signupstudent') !!}" class="my-account-form" style="margin-top: -230px;background: #fff; border-radius: 35px 36px 0px 0px;" method="POST"> 
                        	{{csrf_field()}}
                            <h2 style="padding-bottom:20px; font-style: normal; text-align: center;"><span class="text-green">REGISTER </span> AS STUDENT</h2>
                            ...
                            <input type="text" id="school_code" name="school_code" class="school_code" required minlength="8" maxlength="20" onblur="loadClasses(this)">
                            </div>
                            <div class="col-md-6 float-left">
                            <label for="username"> Class *</label>
                            <select id="city_id" class="class_id" name="class_id" class="class_id" required >
                                <option value=""> Select Class </option>
                            </select> 
                            </div>
                            <div class="col-md-6 float-left">
                            <label for="username"> Academy </label>
                            <select id="state_id" name="academy_id" class="academy_id" >
                            ...
                            <div class="row">
                                <div class="col-md-12 ">
                                    <p style="padding: 15px 0px;">Already have an account? <span style="text-decoration:underline;cursor: pointer;" class="text-green"  onclick="window.location.href='{{URL('/')}}/studentlogin'"  >Login</span></p> 
                                </div>
